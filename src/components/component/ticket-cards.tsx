...
* @see https://v0.dev/t/dXoJ5rz55fM
...
export function TicketCards() {
  const tickets = [
    ...
    },
    {
      ...
      description: "Learn to cook a 3-course meal from a Michelin-starred chef.",
      sold: false,
    },
    {
      id: 5,
          ...
          <div key={ticket.id} className="bg-white rounded-lg shadow-md overflow-hidden">
            <div className="p-4">
              ...
              <div className="flex justify-between items-center">
                {ticket.sold ? (
                  <span className="bg-green-500 text-white px-2 py-1 rounded-full text-xs font-medium">Sold</span>
                ) : (
                  <Button variant="outline" className="px-4 py-2 rounded-full text-xs font-medium">
                    Register
                  </Button>
                )}
              </div>
